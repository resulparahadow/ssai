...
async function generateDraft(input, opts = {}) {
    ...
    return {
        ...
        telemetry: {
            ...
            promiseStatus: s._pendingPassCAdvance?.promiseStatus ?? s._promiseStatus ?? null,
            storyFrameworkStep: s._pendingPassCAdvance?.storyFrameworkStep ?? s._storyFrameworkStep ?? null,
            lastAnalysis: s._lastAnalysis ?? null,
            nextPlannedMove: s._pendingPassCAdvance?.nextPlannedMove ?? s._nextPlannedMove ?? (s.ladder_state ? s.ladder_state.next_planned_move : null) ?? null,
            nextPlannedMoveAtMsg: s._pendingPassCAdvance?.nextPlannedMoveAtMsg ?? s._nextPlannedMoveAtMsg ?? (s.ladder_state ? s.ladder_state.next_planned_at_msg : null) ?? null,
