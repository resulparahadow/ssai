...
// plain url, so fall back to the poster. `direct` media (optimistic Giphy preview) loads as-is.
const proxy = (cdn: string) =>
    current.value?.direct ? cdn : ofApi.mediaUrl(props.modelId, cdn);
